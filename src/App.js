...
function App() {
  ...
  const generateQuiz = async () => {
    ...
    try {
      ...
      const prompt = `Generate a quiz with 10 multiple choice questions about ${topic}. 
      Format the response as a JSON array where each question has:
      - question: string
      - options: array of 4 strings
      - answer: string (the correct answer)
      
      You can customize the format as you seem fit and use the following as reference.
      Example format:
      [
        {
          "question": "What is...?",
